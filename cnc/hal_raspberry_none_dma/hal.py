...
def init():
    ...
    gpio.init(STEPPER_STEP_PIN_X, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(STEPPER_STEP_PIN_Y, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(STEPPER_STEP_PIN_Z, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(STEPPER_STEP_PIN_E, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(STEPPER_DIR_PIN_X, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(STEPPER_DIR_PIN_Y, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(STEPPER_DIR_PIN_Z, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(STEPPER_DIR_PIN_E, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(ENDSTOP_PIN_X, rpgio_none_dma.GPIONoneDMA.MODE_INPUT_PULLUP)
    gpio.init(ENDSTOP_PIN_Y, rpgio_none_dma.GPIONoneDMA.MODE_INPUT_PULLUP)
    gpio.init(ENDSTOP_PIN_Z, rpgio_none_dma.GPIONoneDMA.MODE_INPUT_PULLUP)
    gpio.init(SPINDLE_PWM_PIN, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(FAN_PIN, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(EXTRUDER_HEATER_PIN, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(BED_HEATER_PIN, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
    gpio.init(STEPPERS_ENABLE_PIN, rpgio_none_dma.GPIONoneDMA.MODE_OUTPUT)
